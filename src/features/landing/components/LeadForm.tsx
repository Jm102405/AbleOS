...
'Send the rent roll, T12, OM or photos and we underwrite from real numbers.',
...
export function LeadForm({ assetType, onAssetTypeChange, nameRef }: LeadFormProps) {
  ...
  return (
    <section id="submit" className="relative overflow-hidden bg-brand-mist py-24">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-start gap-14 px-6 lg:grid-cols-2">
        <motion.div
          ...
          <p className="mb-10 max-w-[58ch] text-base leading-relaxed text-brand-ink/70 md:text-lg">
            Have a property that fits our criteria? Send the details and we will come back to you.
            It lands directly with our underwriting team, and we respond same day.
          </p>
        ...
        <motion.div
          ...
          <div className="py-14 text-center">
              ...
              <h3 className="mb-4 text-3xl font-extrabold text-brand-ink">Deal Submitted</h3>
              <p className="mb-8 text-brand-ink/70">
                It went straight to underwriting. We'll confirm receipt and flag anything else we
                need — same day.
              </p>
              <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select id="f-role" name="role" required defaultValue="" className={inputClass}>
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="f-notes" className={labelClass}>
                  Deal Notes <span className="font-normal text-brand-ink/45">(Optional)</span>
                </label>
                <textarea
                id="f-notes"
                name="notes"
              ...
              <div className="rounded-xl border border-brand-ink/10 bg-brand-cream px-4 py-3.5">
                <p className="text-[0.85rem] font-semibold text-brand-ink/80">
                  Have documents?
                </p>
                <p className="mt-1 text-[0.82rem] text-brand-ink/55">
                  Email the rent roll, T12, OM or photos after you submit and we will match them to
                  your deal.
                </p>
                <a
                  className="mt-1.5 inline-block text-[0.82rem] font-medium text-brand-blue hover:underline"
            ...
            <p className="rounded-xl bg-red-50 px-4 py-3 text-[0.88rem] font-medium text-red-700">
              ...
              <ArrowButton type="submit" variant="dark" fullWidth disabled={status === 'submitting'}>
