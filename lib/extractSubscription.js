...
Name the vendor by its short, common brand name, and use the same name every time so one service never appears twice:
- "Notion", not "Notion Labs, Inc."
- "Anthropic", not "Claude", "Claude Team" or "Claude Max"
- "Google Workspace", not "Google"
- "Reventure App", not "Reventure"
- "n8n", not "n8n.io" or "n8n Cloud"

If the email is from a company you don't recognise, use the name as it appears in the sender's domain.`;
